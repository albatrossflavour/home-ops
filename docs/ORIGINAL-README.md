...
> 3. Running the cluster on Proxmox VE? My thoughts and recommendations about that are documented in [Proxmox considerations](https://onedr0p.github.io/home-ops/notes/proxmox-considerations.html).
